...
class View(ft.UserControl):
    ...
    def load_interface(self):
        ...
        self.btn_countedges = ft.ElevatedButton(text="Conta Archi", disabled=True, on_click=self._controller.handle_countedges)
        ...
        self.btn_search = ft.ElevatedButton(text="Cerca cammino", disabled=True, on_click=self._controller.handle_search)
